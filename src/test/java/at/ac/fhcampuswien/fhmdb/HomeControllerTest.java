...
class HomeControllerTest {
    ...
    @Test
    void filterMovies_returns_Action_Movies_cointaining_keyword_avat(){
        HomeController hc = new HomeController();
        ...
        hc.filterMovies(movies, Genres.ACTION, "avat");
        assertEquals("Avatar", movies.get(4).getTitle());
    }

    @Test
    void filterMovies_returns_Action_Movies_noKeyword(){
        HomeController hc = new HomeController();
        ...
        hc.filterMovies(movies, Genres.ACTION, null);
        assertEquals("Avatar", movies.get(4).getTitle());
    }

    @Test
    void filterMovies_returns_Movies_withKeyword_noGenre(){
        HomeController hc = new HomeController();
        ...
        hc.filterMovies(movies, null, "AVAT");
        assertEquals("Avatar", movies.get(4).getTitle());
    }
